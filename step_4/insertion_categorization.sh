...
Rscript --vanilla assign_insertion_categories.R ${INBRED} generegion_summary/${INBRED}_gr_summary.csv insertion_dat_categorized/${INBRED}_dat_cat.csv generegion_summary/graphs/${INBRED}_per1kb.png
